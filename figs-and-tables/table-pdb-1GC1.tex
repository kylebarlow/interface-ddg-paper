...
\end{tabular}
  \caption[Flex ddG performance on PDB 1GC1]{
    Flex ddG performance on PDB 1GC1. Backrub steps = 32500. N = number of mutations in the dataset or subset. R = Pearson's R. MAE = Mean Absolute Error. FC = Fraction Correct.
