...
\begin{figure}
  ...
  \caption[ddG prediction error v. mean backrub ensemble RMSD, v. backrub steps]{
...
\begin{figure}
  ...
  \caption{
    Sigmod-fit Rosetta energy function weights
...
\begin{figure}
  ...
  \caption[Effect of sigmoid fitting on fit vs. experimental ddG values]{
