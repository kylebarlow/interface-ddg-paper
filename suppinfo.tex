...
% \csvstyle{zemuFiltered}{tabular=|c|c|c|c|l|}

% \csvreader[tabular=|c|c|c|c|l|,
% table head=\caption{Filtered ZEMu dataset}\label{tab:zemu-filtered}\\\hline
...
%   \csvautolongtable{figures/table-zemu-filtered.csv}
% \end{table}
